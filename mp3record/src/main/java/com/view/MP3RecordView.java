...
public class MP3RecordView extends RelativeLayout implements View.OnTouchListener {
    ...
    private void initView() {
        ...
        mImagesVolume = new Drawable[]{
                ContextCompat.getDrawable(mContext, R.mipmap.im_record_1),
                ContextCompat.getDrawable(mContext, R.mipmap.im_record_2),
                ContextCompat.getDrawable(mContext, R.mipmap.im_record_3),
                ContextCompat.getDrawable(mContext, R.mipmap.im_record_4),
                ContextCompat.getDrawable(mContext, R.mipmap.im_record_5),
                ContextCompat.getDrawable(mContext, R.mipmap.im_record_6),
                ContextCompat.getDrawable(mContext, R.mipmap.im_record_7),
                ContextCompat.getDrawable(mContext, R.mipmap.im_record_8)};
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case MP3Recorder.MESSAGE_FINISH://录音完成
                    ...
                    break;
                case MP3Recorder.MESSAGE_TIME://录音完成
                    int recordtime = msg.arg1;
                    if(recordtime>50){
                        mTvRecordHint.setText( "还剩"+(maxtime-recordtime)+"秒");
                    }else {
        ...
        timerTask = new TimerTask() {
            ...
            public void run() {
                if(recordtime<maxtime){
                    ...
                    Message message = new Message();
                    message.what = MP3Recorder.MESSAGE_TIME;
